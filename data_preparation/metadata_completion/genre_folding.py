...
GENDER_ORDERING=['Dramatic Readings', 'Poetry', 'Religion','Theater', 'Fiction', 'Science', 'Essay', 'Humor', 'Ancient', 'Non fiction', 'Craft', 'Undefined']

SUPER_GENDER_FOLDING ={'Science, Craft & Essay' : ['Essay', 'Science', 'Craft'],
                       'Literature': ['Fiction', 'Non fiction', 'Humor']}

SUPER_GENDER_ORDERING=['Dramatic Readings','Poetry', 'Religion', 'Literature', 'Science, Craft & Essay', 'Theater', 'Ancient', 'Undefined']
